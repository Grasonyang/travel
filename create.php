  ...
  <div style="height:100%;width:100%;position:relative">
    ...
    <div style="display:inline-block;margin-left:20vw;margin-right:20vw;width:60vw">
      ...
      <div style="text-align:right;">
        <div class="th"><span style="color: rgba(193, 193, 193, 0.937);font-size:1.5vh;margin-right:2vw;">Already have an account?</span><a href="sign-in.php" style="font-size:2vh;color: rgba(255, 254, 254, 0.937);text-decoration:none;">Sign in→</a></div>
      </div>
    </div>
    <div class="blo"></div>
    <div style="height:auto;width:40vw;padding:10px 20px" class="body">
      <div style="margin-bottom:10px;">
        <span style="color: rgba(154, 154, 154, 0.875);">Forget Password?</span>
      </div>
      <div style="margin-bottom:30px;">
        <span style="color: rgba(154, 154, 154, 0.875);">Let’s change passwords</span>
      </div>
      <div>
        <form action="createnode.php?call=0" method="post">
          <div style="margin-bottom:10px;">
            <span style="color: #00cfc8;font-weight:bold;font-size:18px;">Enter your email address</span>
          </div>
          <div style="margin-bottom:10px;">
          ...
          <div style="margin-bottom:10px;">
            <span style="color: #00cfc8;font-weight:bold;font-size:18px;">Input your verification code</span>
          </div>
          <div style="margin-bottom:10px;">
            <span style="color: rgba(255, 24, 205, 0.875);">→</span>
          ...
          <div style="margin-bottom:10px;">
            <span style="color: #00cfc8;font-weight:bold;font-size:18px;">Change your password</span>
          </div>
          <div style="margin-bottom:10px;">
            <span style="color: rgba(255, 24, 205, 0.875);">→</span>
